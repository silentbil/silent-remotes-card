...
let SilentRemotesCard = class SilentRemotesCard extends LitElement {
    ...
    validateConfig(config) {
        ...
        if (!config.commandsFilePath) {
            throw new Error('You need to define commandsFilePath');
        }
            ...
            ? html `
                  <div class="custom">
                    ${(_c = Object.keys(((_b = (_a = this.fullCommands) === null || _a === void 0 ? void 0 : _a.custom) === null || _b === void 0 ? void 0 : _b.commands) || [])) === null || _c === void 0 ? void 0 : _c.map((i) => html `<span
                                class="custom-button"
                                style="font-size: ${this.iconSize}px;border-color: ${this.theme === 'dark'
                ? 'white'
                : 'black'}"
    ...
    changeAcTempp(inc) {
        ...
        if (newState.temperature > this.acConfig.maxTemperature) {
            newState.temperature = this.acConfig.minTemperature;
        }
        if (newState.temperature < this.acConfig.minTemperature) {
            newState.temperature = this.acConfig.maxTemperature;
        }
...
SilentRemotesCard.styles = css `
      ...
      .icon:hover {
        filter: invert(57%) sepia(68%) saturate(5215%) hue-rotate(164deg) brightness(99%) contrast(101%) !important;
      }
